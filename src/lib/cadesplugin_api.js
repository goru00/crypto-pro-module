...
;(function () {
  ...
  function check_browser() {
    var ua = navigator.userAgent; var tem; var M = ua.match(/(opera|yabrowser|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i) || [];
  ...
  function show_firefox_missing_extension_dialog() {
    if (!window.cadesplugin_skip_extension_install) {
      ...
      ovr.innerHTML = `
                <div id='cadesplugin_ovr_item'>
                <button id='cadesplugin_close_install'>Закрыть</button>
